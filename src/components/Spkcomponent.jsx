  ...
  return (
    <div data-aos="zoom-in" className="main-margin mt-[40px]">
        <div data-aos="zoom-in" className=" flex-col md:flex-row flex justify-center items-center gap-[15px] md:mx-[150px] mb-[90px]">
            ...
            <div className="">
                <img className="w-[100%] md:w-[1900px] rounded-[20px]" src="../../public/image/self-host.png" alt="" />
            </div>
        </div>
        <div className=" flex-col md:flex-row-reverse flex justify-center items-center gap-[15px] md:mx-[150px] mb-[90px]">
            ...
            <div className="">
                <img className="w-[100%] md:w-[3100px] rounded-[20px]" src="../../public/image/Censorship.png" alt="" />
            </div>
        </div>
        <div className=" flex-col md:flex-row flex justify-center items-center gap-[15px] md:mx-[150px] mb-[90px]">
            ...
            <div className="">
                <img className="w-[100%] md:w-[1900px] rounded-[20px]" src="../../public/image/Decentralized.png" alt="" />
            </div>
        </div>
        <div className=" flex-col md:flex-row-reverse flex justify-center  items-center gap-[15px] md:mx-[150px] mb-[90px]">
            <div className="text-center md:text-start">
            ...
            <div className="">
                <img className="w-[100%] md:w-[1900px] rounded-[20px]" src="../../public/image/cummunities.png" alt="" />
            </div>
        </div>
        <div className=" flex-col md:flex-row flex justify-center items-center gap-[15px] md:mx-[150px] mb-[90px]">
            <div className="text-center md:text-start">
            ...
            <div className="">
                <img className="w-[100%] md:w-[1900px] rounded-[20px]" src="../../public/image/larynx.png" alt="" />
            </div>
        </div>
