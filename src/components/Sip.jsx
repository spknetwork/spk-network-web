  ...
  return (
    <div>
        <div data-aos="zoom-in" className="main-margin mt-[40px]">
            <div className="flex flex-col justify-center items-center mb-6" data-aos="zoom-in">
                <h1 className=" text-[33px] double-color font-extrabold text-center">SPEAK INFRASTRUCTURE POOL(SIP)</h1>
                <p className="text-[22px] text-center "> The SIP will be responsible for providing a lifetime liquidity pool for the SPK Network.</p>
            </div>
        ...
        <div data-aos="zoom-in"className=" flex-col md:flex-row-reverse flex justify-center items-center gap-[15px] md:mx-[150px] mb-[90px]">
            <div className="text-center md:text-start">
                <h2 className="text-[28px] font-extrabold text-[white]">SPEAK NETWORK TOKENS AND UTILITIES</h2>
